...
CREATE TABLE Special(
  ...
  startingHour INT NOT NULL  CHECK (startingHour >= 0 and startingHour <=24),
  endingHour INT NOT NULL CHECK (endingHour >= 0 and endingHour <=24),
  startingDay INT NOT NULL,
  endingDay INT NOT NULL,
