...
public enum Role implements Principal {
  ...
  /**
   * AccessControlGroup of a manager on the restaurant who can manage the master-data such as offers, products, and
   * other {@link io.oasp.gastronomy.restaurant.staffmanagement.common.api.StaffMember}s. Also can view suppliers.
   */
  // END ARCHETYPE SKIP
  MANAGER("Manager");
